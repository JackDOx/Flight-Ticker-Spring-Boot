package com.ltrha.ticket.modules.minio;

import com.ltrha.ticket.config.minio.MinioConfig;
import com.ltrha.ticket.config.minio.MinioProperties;
import io.minio.*;
...
public class MinioRepo {
    private static final Logger LOGGER = LoggerFactory.getLogger(MinioRepo.class);
    ...
    // Upload Files
    @SneakyThrows
    public void putObject(final String bucketName, final MultipartFile multipartFile, final String filename, final String fileType) {
    ...
    @SneakyThrows
    public List<String> listObjectNames(final String bucketName) {
    ...
    @SneakyThrows
    public boolean removeObject(final String bucketName, final String objectName) {
    ...
    @SneakyThrows
    public String getObjectUrl(final String bucketName, final String objectName) {
    ...
    @SneakyThrows
    public StatObjectResponse statObject(final String bucketName, final String objectName) {
    ...
    @SneakyThrows
    public InputStream getObject(final String bucketName, final String objectName) {
    ...
    @SneakyThrows
    public InputStream getObject(final String bucketName, final String objectName, final long offset, final Long length) {
    ...
    @SneakyThrows
    public boolean removeObject(final String bucketName, final List<String> objectNames) {
        LOGGER.info("MinioUtil | removeObject is called");
    ...
    @SneakyThrows
    public boolean putObject(final String bucketName, final String objectName, final InputStream inputStream, final String contentType) {
